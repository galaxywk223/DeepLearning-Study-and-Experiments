...
更合适的比较方式，是把“粒度、规模、生成观感、工程形态”放在一起看：

| 模型 | token 粒度 | 参数量 | 最佳验证困惑度 | 生成观感 | 主要看点 |
| --- | --- | ---: | ---: | --- | --- |
| `char-transformer v3` | 字符级 | 2,286,593 | `4.63` | 当前仓库里更成熟、更像对白的生成结果 | 最小 Transformer 结构更直观 |
| `subword-gpt v2` | 子词级 BPE | 9,194,976 | `13.19` | 仍有明显语义不稳，但局部短句已开始成形 | 训练和生成流程更完整 |
