...
卷积本身是一个数学运算，但在深度学习中，它通常是通过“局部窗口滑动并聚合信息”的方式被理解的。先建立这个直觉，再去看公式，会更容易理解它为什么适合处理图像。
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/0505f9afc6aa47e69fabc9253073a5f4.png)


如果要找点数和为 `6` 的情况，只需要把下标和为 `6` 的格子取出来。它们恰好落在从右上到左下的一条直线上：

> ![在这里插入图片描述](../assets/images/02-cnn-mnist/4b1ca22dbeeb45bcb8fc2844a5baa5f8.png)
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/5490e8bfbe8a42a2b7178d4bc81380d2.png)


这样一来，原本的对角线关系就更接近“从左上到右下的滑动窗口”。

> ![在这里插入图片描述](../assets/images/02-cnn-mnist/a9d136005fda4ae5aa05fa98c80808b4.png)


接下来只保留和当前目标有关的部分，其余位置用空白补齐：

> ![在这里插入图片描述](../assets/images/02-cnn-mnist/9b735fe6e83f4c70bb4f1fa1edb2e3c5.png)
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/503c253009f8480790f80f9d1034f57a.png)


也就是说，“求点数和的分布”可以理解成“把一个窗口滑过去，并在每个位置做乘积求和”。

如果两个序列长度不同，这个过程也一样成立。可以画成下面这样的滑动示意：
>![在这里插入图片描述](../assets/images/02-cnn-mnist/6e09481e5b204df2b8affb3e25e5ab5b.png)
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/9bfa53aaef0a45bc8c6b770ecc58f486.png)


这组数据波动较大。如果想让它更平滑，可以定义一个简单的卷积核 `[1/3, 1/3, 1/3]`。它的作用，就是在每个位置取一个局部窗口，对邻近值做平均。
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/e37001573f87444f8509f53d099ebaed.png)
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/331d071b65004550bc264cd8720313ac.png)
...
下图展示了这种对齐关系：
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/9ed485ded2384bce9565db673d088d5b.png)
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/b7c64a37fa5648c8ad1b700a658800c0.png)


定义一个和一维情况类似的局部窗口操作：
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/55a282bac1d942238e8e1ce3a6b6604b.png)
...
我们把它可视化出来：
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/2be481368aa2487b92ef58d23fbfcff6.png)
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/0df967979d154160ad745a7c901a3b34.png)
...
输入灰度手写数字7图片
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/89d0e0c3a5524e9ba26fd17845194130.png)


第一层使用 `16` 个卷积核，因此会得到 `16` 张特征图：
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/7b30375bc1d043ebaa7ef4ce63afc77a.png)
...
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/d8db652a6dc2496fad6377b408694bf1.png)


使用 `2x2` 池化时，特征图的高和宽都会减半，因此空间尺寸会缩小到原来的 `1/4`。这样做既能减少计算量，也能保留局部最显著的响应。

池化后的图片像下面这样：
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/6992c40592c841f397babcf42292973b.png)


随后重复相同流程，再做一层卷积。这一层把通道数从 `16` 增加到 `32`：
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/293026207ec040a1ae49071d917893a8.png)


接着继续通过激活函数，再池化处理，如下图所示：
> ![在这里插入图片描述](../assets/images/02-cnn-mnist/8aca09515e9f4c30890a386efd87846c.png)
...
可以看到，相比基础 MLP，这个 CNN 在 MNIST 上通常能达到更高的准确率。这也是因为它更适合处理图像中的局部空间结构。
